(module
 ...
 (data (i32.const 592) "\04\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00A\08\00\00\02\00\00\00")
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 (export "add" (func $assembly/index/add))
 (export "Int8Array_ID" (global $assembly/index/Int8Array_ID))
 (export "memory" (memory $0))
 (export "getMovedBoard" (func $export:assembly/index/getMovedBoard))
 (start $~start)
    ...
    block $~lib/arraybuffer/ArrayBufferView
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       ...
       i32.sub
       i32.load
       br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/typedarray/Int8Array $invalid
      end
      return
     end
     return
 ...
 (func $assembly/index/getMovedBoard (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $export:assembly/index/getMovedBoard (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  local.get $1
  call $assembly/index/getMovedBoard
  local.set $2
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
